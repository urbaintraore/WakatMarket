/**
 * Helpers partagés des Cloud Functions WakatMarket (SDK v2).
 *
 * Modèle de données Firestore (même schéma snake_case que l'ancien Postgres
 * pour conserver les mappers du client) :
